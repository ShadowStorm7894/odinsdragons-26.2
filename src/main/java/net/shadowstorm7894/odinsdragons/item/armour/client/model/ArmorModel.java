package net.shadowstorm7894.odinsdragons.item.armour.client.model;
...
public class ArmorModel extends HumanoidModel<LivingEntity> {
    ...
    public void renderToBuffer(@NotNull PoseStack stack, @NotNull VertexConsumer consumer, int packedLight, int packedOverlay, int colour) {
        super.renderToBuffer(stack, consumer, packedLight, packedOverlay, colour);
        this.leftBoot.render(stack, consumer, packedLight, packedOverlay, colour);
        this.rightBoot.render(stack, consumer, packedLight, packedOverlay, colour);
    }
}
